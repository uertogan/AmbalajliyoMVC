...
namespace AmbalajliyoMVC.Areas.MusteriHizmetleri.Controllers
{
    ...
    [Authorize(Roles = "Müşteri Hizmetleri")] // JWT token'daki rolü kontrol eder
    public class MusteriHizmetleriCustomerController : Controller
    {
        private readonly CustomerAPIService _customerAPIService;
        private readonly ProductAPIService _productAPIService;

        public MusteriHizmetleriCustomerController(CustomerAPIService customerAPIService, ProductAPIService productAPIService)
        {
