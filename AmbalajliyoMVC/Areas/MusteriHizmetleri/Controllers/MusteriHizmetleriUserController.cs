...
namespace AmbalajliyoMVC.Areas.MusteriHizmetleri.Controllers
{
    ...
    public class MusteriHizmetleriUserController : Controller
    {
        private readonly UserAPIService _userAPIService;
        private readonly RoleAPIService _roleAPIService;

        public MusteriHizmetleriUserController(UserAPIService userAPIService, RoleAPIService roleAPIService)
        {
