...
namespace AmbalajliyoMVC.Areas.Admin.Controllers
{
    ...
    public class AdminCategoryController : Controller
    {
        ...
        public AdminCategoryController(CategoryAPIService categoryAPIService, ProductAPIService productAPIService)
        {
        ...
        {
            var allCategories = await _categoryAPIService.GetAllCategoryAsync();
            var pagedItems = allCategories.ToPagedList(page, 10);
