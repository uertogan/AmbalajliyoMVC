...
namespace AmbalajliyoMVC.Areas.IcerikYoneticisi.Controllers
{
    ...
    public class IcerikYoneticisiProductController : Controller
    {
        private readonly ProductAPIService _productAPIService;
        private readonly CategoryAPIService _categoryAPIService;

        public IcerikYoneticisiProductController(ProductAPIService productAPIService, CategoryAPIService categoryAPIService)
        {
        ...
        public async Task<IActionResult> GetAllProduct(int page = 1) // bütün ürünleri getir
        {
            ...
            var pagedItems = products.ToPagedList(page, 12);
        ...
        public async Task<IActionResult> CreateProduct(ProductViewModel productViewModel)
        {
            ...
            return RedirectToAction(nameof(GetAllProduct)); // ekleme işleminden sonra bütün ürünleri listelenmesi için GetAllProduct metodunu çağır.
        ...
        public async Task<IActionResult> UpdateProduct(string? id)
        {
            ...
            try
            {
                ...
                if (product == null)
                {
                    return NotFound(); // API'den ürün alınamadı
                }
        ...
        {
            //Güncelleme ekranında güncellenecek olan ürün bilgileri geldikten sonra, yeni bilgiler yazılır ve sonra Save butonuna basıldığı zaman Edit'in POST'una gider. (Yani buraya gelir)
